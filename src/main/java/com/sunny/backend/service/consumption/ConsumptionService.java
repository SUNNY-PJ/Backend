...
public class ConsumptionService {
	...
	public ResponseEntity<CommonResponse.ListResponse<ConsumptionResponse.DetailConsumption>> getDetailConsumption(
		...
		List<ConsumptionResponse.DetailConsumption> detailConsumptions = ConsumptionResponse.DetailConsumption.fromDetailConsumptions(
			detailConsumption);
		return responseService.getListResponse(HttpStatus.OK.value(), detailConsumptions,
			datefield + " 에 맞는 지출 내역을 불러왔습니다.");
	}
