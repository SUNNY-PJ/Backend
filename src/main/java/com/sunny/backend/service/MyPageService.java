...
public class MyPageService {
    ...
    // 내가 쓴 글
    @Transactional
    public CommonResponse.ListResponse<CommunityResponse.PageResponse> getMyCommunity (CustomUserPrincipal customUserPrincipal) {
    ...
    public CommonResponse.ListResponse<CommentResponse> getCommentByUserId(CustomUserPrincipal customUserPrincipal) {
        Users user = customUserPrincipal.getUsers();
...
//        List<CommentResponse> commentRes = new ArrayList<>();
    ...
    //스크랩 한 글
    @Transactional
    public CommonResponse.ListResponse getScrapByUserId(CustomUserPrincipal customUserPrincipal) {
        Users user = customUserPrincipal.getUsers();
    ...
    @Transactional
    public CommonResponse.SingleResponse<ProfileResponse> updateProfile(CustomUserPrincipal customUserPrincipal, MultipartFile profile, String nickname) {
        Users user = customUserPrincipal.getUsers();
