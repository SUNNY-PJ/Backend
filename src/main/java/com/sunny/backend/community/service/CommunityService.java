...
public class CommunityService {
	...
	@Transactional
	public CommunityResponse findCommunity(CustomUserPrincipal customUserPrincipal, Long communityId) {
	...
	@Transactional
	public ViewAndCommentResponse getCommentAndViewByCommunity(
		Long communityId
	) {
		Community community = communityRepository.getById(communityId);
