...
public class CompetitionController {
	...
	public ResponseEntity<CommonResponse.GeneralResponse> applyCompetition(
		...
		return competitionService.applyCompetition(customUserPrincipal, competitionApply);
	}
	...
	public ResponseEntity<CommonResponse.GeneralResponse> acceptCompetition(
		...
		return competitionService.acceptCompetition(customUserPrincipal, competitionAccept);
	}
